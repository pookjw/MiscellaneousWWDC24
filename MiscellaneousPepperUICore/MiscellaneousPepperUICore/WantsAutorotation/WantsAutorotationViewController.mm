//
//  WantsAutorotationViewController.mm
...
@implementation WantsAutorotationViewController
...
+ (Class)dynamicIsa {
    ...
    dispatch_once(&onceToken, ^{
        Class _dynamicIsa = objc_allocateClassPair(objc_lookUpClass("SPViewController"), "_WantsAutorotationViewController", 0);
...
- (void)toggle __attribute__((objc_direct)) {
    ...
    BOOL wantsAutorotation = reinterpret_cast<BOOL (*)(id, SEL)>(objc_msgSend)(sharedPUICApplication, sel_registerName("wantsAutorotation"));
    
    reinterpret_cast<void (*)(id, SEL, BOOL)>(objc_msgSend)(sharedPUICApplication, sel_registerName("setWantsAutorotation:"), wantsAutorotation ^ 1);
}
