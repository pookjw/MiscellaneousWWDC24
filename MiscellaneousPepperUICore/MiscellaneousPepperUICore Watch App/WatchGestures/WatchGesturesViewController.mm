...
+ (Class)class {
    ...
    dispatch_once(&onceToken, ^{
        Class _isa = objc_allocateClassPair(objc_lookUpClass("SPViewController"), "_WatchGesturesViewController", 0);
        ...
        assert(class_addMethod(_isa, @selector(foo:), foo, NULL));
        ...
        assert(class_addMethod(_isa, @selector(didTriggerInvalidActionBarButtonItem:), didTriggerInvalidActionBarButtonItem, NULL));
