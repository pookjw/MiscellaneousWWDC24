...
+ (Class)class {
    ...
    dispatch_once(&onceToken, ^{
        Class _isa = objc_allocateClassPair(objc_lookUpClass("SPViewController"), "_QuickboardCompositionPresenterViewController", 0);
        ...
        assert(class_addMethod(_isa, @selector(composeControllerCancelled:), composeControllerCancelled, NULL));
